        ...
        <>
            <div className="container">
                <div style={{padding:"0 5rem"}}>
                    ...
                    <TextArea rows={6} placeholder="maxLength is 6" maxLength={6} style={{background:"color", border:"1px solid grey"}} />
                </div>
            </div>
        </>
    );
      ...
      <div>
        <div className="container developerAPI-wrapper" >
          ...
          <div style={{margin:"3rem 0"}}>
            <h3 style={{padding:"0 5rem"}}>Developer - API</h3>
            <DeveloperComp 
                title="Choose &amp; Customize Interface"
            />
            <DeveloperComp 
                title="Bank Account"
            />
